# Contributing to Tuner UI

Thank you for your interest in contributing to Tuner UI! This document provides guidelines and instructions for contributing to the project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/tuner-ui.git
   cd tuner-ui
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/ORIGINAL_OWNER/tuner-ui.git
   ```
...
Thank you for contributing to Tuner UI!
