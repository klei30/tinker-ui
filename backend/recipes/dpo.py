...
class CLIConfig:
    ...
    dataset: str = (
        "hhh"  # or path like tinker_cookbook.preference.preference_datasets:HHHBuilder
    )
...
def get_dataset_builder(
    ...
    if dataset == "hhh":
        ...
        return DPODatasetBuilderFromComparisons(
            ...
            comparison_builder=HelpSteer3ComparisonBuilder(),
        )
    elif dataset == "ultrafeedback":
        return DPODatasetBuilderFromComparisons(
            common_config=common_config,
            comparison_builder=UltraFeedbackComparisonBuilder(),
        )
    else:
